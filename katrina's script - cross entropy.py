...
for epoch in range(num_epochs):
    ...
    for batch_idx, (L, ab) in enumerate(train_loader):
        for batch_idx, (L, ab) in enumerate(train_loader):
            ...
            # Convert ab (target) to appropriate indices if needed
            target_ab = torch.argmax(ab, dim=1)  # Example for classification tasks
...
test_image_path = '/pscratch/sd/l/liamfox/colorization/Dog_grayscale.jpg'
