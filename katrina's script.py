...
# Import the ECCV16 model from your colorization codebase
...
data_transform = transforms.Compose([
    ...
    # Optionally, add data augmentations here (e.g., random flips, rotations)
])
...
train_root = '/global/homes/k/kcelario/imagenet-mini-split/train'
val_root = '/global/homes/k/kcelario/imagenet-mini-split/val'
...
# Optionally, freeze certain layers (e.g., encoder) if you want
...
test_image_path = '/global/homes/k/kcelario/colorization/imgs/input_parrots.jpg'
...
def test_model(model, img_path):
    ...
    output_ab = output_ab * 110.0  # Denormalize ab channels
    L = L.cpu().numpy()[0][0]
    ...
    plt.savefig('colorized_output.png')  # <-- This line will save the output to 'colorized_output.png'
